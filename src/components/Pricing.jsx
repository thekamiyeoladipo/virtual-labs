...
const Pricing = () => {
  return (
    <div id="pricing" className="mt-20">
        ...
        text-center my-8 tracking-wider">Pricing
        </h2>
        <div className="flex flex-wrap">
            {pricingOptions.map((option, index) => (
                <div key={index} className="flex items-center justify-center w-full sm:w-1/2
                lg:w-1/3 p-2">
<<<<<<< HEAD
                    <div className="p-20 border rounded-xl">
                    ...
                    <p className="text-4xl mb-8">
                        ...
                        {option.title === "Pro" && (
                            ...
                            bg-clip-text text-xl mb-4 ml-2">
                             (Most popular)   
>>>>>>> d165090a0cfbd8d45b0fd34287764f29ce8c6a6f
                            </span>
                        )}
                    </p>
                    <p className="mb-4">
                    ...
                    h-12 p-5 mt-20 tracking-tight text-xl hover:bg-orange-900 border border-orange-900 rounded-lg transition duration-200">
                        Subscribe
                    </a>
                    </div>
                </div>
